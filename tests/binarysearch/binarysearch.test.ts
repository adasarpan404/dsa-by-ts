...
describe('First and Last Positions', () => {
    ...
    test('should return correct range for target present in array', () => {
    ...
    test('should return [-1, -1] for target not present in array', () => {
        const nums = [5, 7, 7, 8, 8, 10];
        const target = 6;
    ...
    test('should return [0, 0] for single element array with target present', () => {
        const nums = [5];
        const target = 5;
    ...
    test('should return [-1, -1] for single element array with target not present', () => {
        const nums = [5];
        const target = 6;
        const expectedRange = [-1, -1];
        expect(solution.searchRange(nums, target)).toEqual(expectedRange);
    ...
    test('should return correct range for target present at both ends of array', () => {
...
describe('Solution', () => {
    ...
    test('should find the index of target element in a sorted rotated array', () => {
...
describe('k-th positive', () => {
    test('should return the k-th missing positive integer', () => {
        const nums = [2, 3, 4, 7, 11];
        const k = 5;
        expect(findKthPositive(nums, k)).toBe(9);
    });

    test('should return the k-th missing positive integer when k is 1', () => {
        const nums = [1, 2, 3, 4, 5];
        const k = 1;
        expect(findKthPositive(nums, k)).toBe(6);
    });

    test('should return the k-th missing positive integer when k is greater than the missing integers count', () => {
        const nums = [1, 2, 3];
        const k = 5;
        expect(findKthPositive(nums, k)).toBe(7);
    });

    test('should return the k-th missing positive integer when nums contains duplicate values', () => {
...
describe('findMissingNumber', () => {
    ...
    test('should return the smallest missing positive integer when the array contains negative numbers', () => {
        const nums = [-1, -2, 0, 1, 2, 4, 5]; // The smallest missing positive integer is 3
        expect(findMissingNumber(nums)).toBe(3);
    });

    test('should return the smallest missing positive integer when the array contains duplicate values', () => {
        const nums = [0, 1, 1, 2, 2, 4, 4, 5]; // The smallest missing positive integer is 3
        expect(findMissingNumber(nums)).toBe(3);
    });

    test('should return the smallest missing positive integer when the array contains only negative numbers', () => {
        const nums = [-5, -4, -3, -2, -1]; // The smallest missing positive integer is 1
        expect(findMissingNumber(nums)).toBe(1);
    });

    test('should return the smallest missing positive integer when the array contains only non-positive numbers', () => {
